...
class RecordFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recordItems = listOf(
            ...
            RecordItem("2024.08.15", "보수동 책방 골목에서 지식 한입..", "https://i.namu.wiki/i/wyHJ3OXY5pfTiIjtuWek4lkudrawOASZb9zxBa3eT1D7x1XTQyvHYU7leVN83i7Vc4IdmBCr4Hpuo7DFyJJk3Q.webp")
